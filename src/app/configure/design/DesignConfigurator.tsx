...
const DesignConfigurator = ({
  ...
  return (
    <div className="relative my-20 pb-20 grid grid-cols-1 lg:grid-cols-5">
      <div className="relative h-[37.5rem] overflow-hidden col-span-3 w-full max-w-4xl flex items-center justify-center rounded-lg border-2 border-dashed border-gray-300 p-12 text-center focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2">
